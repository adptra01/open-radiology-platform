...
| **M9** | **In-progress (2026-09-18)** | Stabilisasi fork AqQkIio1 → DCM4CHE: root `.gitignore`, hapus `*.bak`, VR SH 0-warning, verifikasi penuh **127/526 + 12 + 7, tsc 0, build 7.42s, compose dev+prod valid**. Sisa: `git rm --cached data/`, keputusan ORD vs SH, bobot TB, OHIF v3, build image `orp-ris:latest` |

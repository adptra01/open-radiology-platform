...
| **M11** | **Backlog (Phase 2-5)** | E2E bobot real + cutover `orp_ai`→`ai_gateway` (hapus shim/card legacy); evaluasi + threshold terkalibrasi; integrasi penuh; auditability. Out-of-scope tetap: model CT/MR/US, LLM report, auto-diagnosis |
